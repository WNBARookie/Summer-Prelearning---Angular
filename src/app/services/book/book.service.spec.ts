...
describe('BookService', () => {
  ...
  it('should fetch all books', () => {
    ...
    const request = http.expectOne('/assets/mocks/books.json');
  ...
  it('should remove a book', () => {
    ...
    const request = http.expectOne(`/assets/mocks/books.json/?id=${bookId}`);
  ...
  it('should update a book', () => {
    ...
    // const request = http.expectOne('http://localhost:8080/');
    const request = http.expectOne(`/assets/mocks/books.json/?id=${book.id}`);
